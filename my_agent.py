...
def newGeneration(old_population):
    ...
    for n in range(N):
        ...
        # Splits the mother and father chromosomes in half then combines them into a new chromosome
        ...
        # Sets the new_chromosome to the new snakes chromosome and adds it new_population
